...
import com.example.android.inventoryappstage2.data.BookDbHelper;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private void deleteAllBooks() {
        int deleteAll = getContentResolver().delete(BookEntry.CONTENT_URI, null, null);
        Toast.makeText(this, getString(R.string.deleted_all_books_message), Toast.LENGTH_SHORT).show();
    }
